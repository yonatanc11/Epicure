...
function AboutSection() {
  ...
  return (
    <section className="px-6 py-8 flex flex-col items-center bg-bg">
      <div className={`max-w-5xl mx-auto w-full flex ${isMobile ? 'flex-col items-center' : 'flex-row items-center justify-between gap-12'}`}>
        ...
        {!isMobile && (
          <div className="shrink-0 flex items-center justify-center pl-8">
            <img src={ICONS.logoBig} alt="Epicure logo" className="w-40 lg:w-48" />
          </div>
        )}
      </div>
    </section>
